    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border border-zinc-200 rounded-lg">
                ...
                <!-- Table -->
                <div class="overflow-x-auto" x-data="{ deleteCategoryId: null, deleteCategoryName: '' }">
                                ...
                                <tr class="hover:bg-zinc-50 transition duration-100">
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="inline-flex items-center gap-1">
                                            <x-secondary-button href="{{ route('categories.edit', $category) }}" class="h-7 px-2.5 text-xs">
                                                Edit
                                            </x-secondary-button>
                    ...
                    <x-modal name="confirm-category-deletion" focusable maxWidth="sm">
                        <form method="post" x-bind:action="'{{ route('categories.destroy', 'CATEGORY_ID') }}'.replace('CATEGORY_ID', deleteCategoryId)" class="p-6">
                            @csrf
                            @method('DELETE')
                            ...
                            <p class="mt-2 text-sm text-zinc-600">
                                Are you sure you want to delete category: <strong class="text-zinc-900" x-text="deleteCategoryName"></strong>?
                            </p>
